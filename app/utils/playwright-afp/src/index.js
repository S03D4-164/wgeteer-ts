...
const protectIt = async (pageOrContext, options) => {
  await pageOrContext.addInitScript((options) => {
    ...
    const noisify = (canvas, context) => {
      if (context) {
        const shift = {
          r: window.afpOptions.canvasRgba
            ? window.afpOptions.canvasRgba[0]
            : Math.floor(Math.random() * 10) - 5,
          g: window.afpOptions.canvasRgba
            ? window.afpOptions.canvasRgba[1]
            : Math.floor(Math.random() * 10) - 5,
          b: window.afpOptions.canvasRgba
            ? window.afpOptions.canvasRgba[2]
            : Math.floor(Math.random() * 10) - 5,
          a: window.afpOptions.canvasRgba
            ? window.afpOptions.canvasRgba[3]
            : Math.floor(Math.random() * 10) - 5,
        };
            ...
            proto.getParameter = new Proxy(proto.getParameter, {
              apply(target, receiver, args) {
                if (args[0] === 3415) return 0;
                  ...
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3378']
                    : config.random.number([14, 15]);
                else if (args[0] === 36347)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['36347']
                    : config.random.number([12, 13]);
                else if (args[0] === 34076)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['34076']
                    : config.random.number([14, 15]);
                else if (args[0] === 34024)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['34024']
                    : config.random.number([14, 15]);
                else if (args[0] === 3386)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3386']
                    : config.random.int([13, 14, 15]);
                else if (args[0] === 3413)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3413']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 3412)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3412']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 3411)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3411']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 3410)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['3410']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 34047)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['34047']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 34930)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['34930']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 34921)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['34921']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 35660)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['35660']
                    : config.random.number([1, 2, 3, 4]);
                else if (args[0] === 35661)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['35661']
                    : config.random.number([4, 5, 6, 7, 8]);
                else if (args[0] === 36349)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['36349']
                    : config.random.number([10, 11, 12, 13]);
                else if (args[0] === 33902)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['33902']
                    : config.random.float([0, 10, 11, 12, 13]);
                else if (args[0] === 33901)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['33901']
                    : config.random.float([0, 10, 11, 12, 13]);
                else if (args[0] === 37446)
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['37446']
                    : config.random.item([
                        'Graphics',
                        'HD Graphics',
                        'Intel(R) HD Graphics',
                  ...
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['7938']
                    : config.random.item([
                        'WebGL 1.0',
                        'WebGL 1.0 (OpenGL)',
                  ...
                  return window.afpOptions.webglData
                    ? window.afpOptions.webglData['35724']
                    : config.random.item([
                        'WebGL',
                        'WebGL GLSL',
                        'WebGL GLSL ES',
    ...
    const rand = {
      noise: () => {
        console.log('doing noise');
        const SIGN = Math.random() < Math.random() ? -1 : 1;
        return window.afpOptions.fontFingerprint
          ? window.afpOptions.fontFingerprint.noise
      ...
      sign: () => {
        ...
        return window.afpOptions.fontFingerprint
          ? window.afpOptions.fontFingerprint.sign
          : tmp[index];
      },
    };
          ...
          apply(target, self, args) {
            ...
            if (context.BUFFER !== results_1) {
              ...
              for (let i = 0; i < results_1.length; i += 100) {
                const index = Math.floor(
                  (window.afpOptions.audioFingerprint
                    ? window.afpOptions.audioFingerprint
    ...
    // Web RTC
    if (window.afpOptions.webRTCProtect)
    ...
    Object.defineProperty(navigator, 'deviceMemory', {
      get: () =>
        window.afpOptions.deviceMemory
          ? window.afpOptions.deviceMemory
  ...
  return pageOrContext;
};

module.exports = { protectIt };
